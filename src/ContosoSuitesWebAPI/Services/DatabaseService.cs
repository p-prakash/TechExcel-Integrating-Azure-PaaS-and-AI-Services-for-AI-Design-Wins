...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("Date in Datetime to find bookings after the provided value")] DateTime dt)
    {
    ...
    /// <summary>
    /// Get bookings for a specific hotel that are missing rooms.
    /// </summary>
    [KernelFunction]
    [Description("Get bookings for a specific hotel that are missing hotel rooms.")]
    ...
    /// <summary>
    /// Get bookings for a specific hotel with multiple rooms.
    /// </summary>
    [KernelFunction]
    [Description("Get bookings for a specific hotel with multiple rooms.")]
